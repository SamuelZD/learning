 ...
 *
 */
public class Solver1LimitedPollingEM {
	...
	public Solver1LimitedPollingEM() {
		this.N = 0;
	...
	private class QueueInfo {
		...
		private double m; // the real batch size
		...
		/**
		 * set the real batch size (relative)
		 * @param m_
		 */
