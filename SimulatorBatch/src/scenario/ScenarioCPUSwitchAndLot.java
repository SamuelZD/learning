 ...
 *
 */
public class ScenarioCPUSwitchAndLot {
	...
	public static void main(String[] args) {
		...
		// Input parameters
		int N = 6; // number of queue served in by the processor
		...
		System.out.println("* Batch = "+ (Configuration.EXTRALOT+1));
		...
		Server server = new SimpleSwitchLotServer();
		( (SimpleSwitchLotServer)server ).setSwitchDistribution(new Exponential(Configuration.SWITCHRATE));
		...
		double lambda_3 = 0.18*Lambda;
		double lambda_4 = 0.22*Lambda;
...
//		}
		...
		solverSwitch.addQueue(K, lambda_4, mu_4);
		solverSwitch.addQueue(K, lambda_5, mu_5);
