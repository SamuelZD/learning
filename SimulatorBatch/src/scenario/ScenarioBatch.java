...
public class ScenarioBatch {
	...
	public static void main(String[] args) {
		...
		serviceHit[0] = new Constant(1/muh_0);
		serviceHit[1] = new Constant(1/muh_0);
		serviceHit[2] = new Constant(1/muh_0);
		
		serviceMiss[0] = new Constant(1/mum_0);
		serviceMiss[1] = new Constant(1/mum_0);
		serviceMiss[2] = new Constant(1/mum_0);
		
		
		release[0] = new Constant(1/mur_0);
		release[1] = new Constant(1/mur_0);
		release[2] = new Constant(1/mur_0);
...
//		arrival[0] = new Constant(1/lambda_0);
//		arrival[1] = new Constant(1/lambda_1);
//		arrival[2] = new Constant(1/lambda_2);
		...
		for( int i = 0 ; i < N ; i++ )
		{
			...
			if( lower > 1/mus.get(i)) System.out.println("Queue(" + (i+1) + ") is wrong"   );
		...
		for(int i = 0; i < mus.size() ; i++)
			System.out.print("time(" + (i+1) + ") : " + 1/mus.get(i) + " " + svtm.get(i) + " " + 1/musBatch.get(i) + " ");
		System.out.println("");
		...
		solver.addQueue(K, lambda_0, mus.get(0));
		solver.addQueue(K, lambda_1, mus.get(1));
		solver.addQueue(K, lambda_2, mus.get(2));
		
		// Add the batch and cache parameters to the solver
//		solver.setTimeParameters(1/mum_0, 1/muh_0, 1/mur_0); //service time
//		solver.setBatchSize(Configuration.EXTRALOT + 1); // batch size
